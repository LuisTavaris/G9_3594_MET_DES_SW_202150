...
public class MongoDBManager extends noSqlDBManager {
   ...
   public boolean update(String oldData, int newData) {
        BasicDBObject query = new BasicDBObject();
        query.put("Stock", oldData);
        BasicDBObject newDocument = new BasicDBObject();
        newDocument.put("Stock", newData);
        BasicDBObject updateObject = new BasicDBObject();
        updateObject.put("$set", newDocument);
        setCollections(getBaseData().getCollection("Stock"));
    ...
    ///////////////////////////////////////////////////////////////////////////
        ...
        public void readF() {
             openConnection();
        collections = BaseData.getCollection("ListaMateriaPrima");        
        cursor = collections.find();
        while (cursor.hasNext()) {
            System.out.println(cursor.next().get("Producto"));            
        }
    }
