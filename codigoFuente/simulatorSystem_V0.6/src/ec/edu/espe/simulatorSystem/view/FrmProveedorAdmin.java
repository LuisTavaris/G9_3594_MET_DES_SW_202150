 ...
 * @author luist
 */
public class FrmProveedorAdmin extends javax.swing.JFrame {
 ...
 public void ValidarIngresosTabla(){
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        try{
            dataBase.borrarProveedor(tablaProveedor);
            dataBase.verProveedor(tablaProveedor);
        }catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProveedorAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmProveedorAdmin().setVisible(true);
            }
        });
    }
