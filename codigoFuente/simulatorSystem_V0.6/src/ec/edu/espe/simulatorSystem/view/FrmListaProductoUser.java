 ...
 * @author luist
 */
public class FrmListaProductoUser extends javax.swing.JFrame {

     DBCollection collection;
    DB dataBase;
  
    
    public FrmListaProductoUser() {
          try {
    ...
    FrmProductoUser frm = new FrmProductoUser();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmListaProductoUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmListaProductoUser().setVisible(true);
            }
        });
    }
