 ...
 * @author luist
 */
public class FrmProductoUser extends javax.swing.JFrame {
   ...
   public double Venta(){
    ...
    private void jButtonListaProductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListaProductosActionPerformed
       ...
       FrmListaProductoUser producto = new FrmListaProductoUser();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProductoUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmProductoUser().setVisible(true);
            }
        });
    }
